      ...
      <div className="about-container">
        ...
        <section className="about-content">
          ...
          <div className="about-section">
            ...
            <p>
              This application was built as part of the SheCodes React workshop.
              It combines dictionary data with additional language-learning
              features to help users understand and explore English words.
            </p>

            <p>
              Users can search for words and explore definitions, pronunciation,
              examples, synonyms, translations and practical grammar
              explanations.
            </p>
          </div>
          ...
          <div className="about-section">
            ...
            <p>
              The app also includes browser-based pronunciation and translation
              features, allowing users to listen to English words and their
